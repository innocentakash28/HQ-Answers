...
class MyClient(discord.Client):
    ...
    async def on_message(self, message: discord.Message):
        ...
        if message.author == self.user or \
                message.channel.id != 713305013115682828 or \
                not self.isGameLive:
            return
    ...
    async def showChecker(self):
        ...
        while not self.is_closed():
            ...
            if broadcast:
                ...
                channel = self.get_channel(713305013115682828)
...
if __name__ == '__main__':
    client = MyClient()
    client.run('NzEzMzAwOTQwMDg1NjU3NjI4.XseHTQ.eKBc9OoGUQpuv4QqPkJyx4lipWs')
